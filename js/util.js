...
///////////////////////////////////////////////////////////////////
    ...
    this.makemercury = function (radius) {
        radius = typeof radius !== 'undefined' ?  radius : this.mercuryRadius;

        var geo = new THREE.SphereGeometry(radius, 32, 32);

        var map = THREE.ImageUtils.loadTexture("img/mercurymap.jpg");

        var bump = THREE.ImageUtils.loadTexture("img/mercurybump.jpg");
    ...
    this.makevenus = function (radius) {
        radius = typeof radius !== 'undefined' ?  radius : this.venusRadius;

        var geo = new THREE.SphereGeometry(radius, 32, 32);

        var map = THREE.ImageUtils.loadTexture("img/venusmap.jpg");

        var bump = THREE.ImageUtils.loadTexture("img/venusbump.jpg");
    ...
    this.makeearth = function (radius,moonPosition) {
        radius = typeof radius !== 'undefined' ?  radius : this.earthRadius;
        moonPosition = typeof moonPosition !== 'undefined' ? moonPosition : this.moonPosition;

        var geo = new THREE.SphereGeometry(radius, 32, 32);

        var map = THREE.ImageUtils.loadTexture("img/earthmap.jpg");

        var bump = THREE.ImageUtils.loadTexture("img/earthbump.jpg");
        ...
        var moon = this.makeMoon(radius/7);

        moon.position.set(radius + moonPosition,0,0);
    ...
    this.makemars = function (radius) {

        radius = typeof radius !== 'undefined' ?  radius : this.marsRadius;

        var geo = new THREE.SphereGeometry(radius, 32, 32);

        var map = THREE.ImageUtils.loadTexture("img/marsmap.jpg");

        var bump = THREE.ImageUtils.loadTexture("img/marsbump.jpg");
    ...
    this.makejupiter = function (radius) {

        radius = typeof radius !== 'undefined' ?  radius : this.jupiterRadius;

        var geo = new THREE.SphereGeometry(radius, 32, 32);

        var map = THREE.ImageUtils.loadTexture("img/jupitermap.jpg");
    ...
    this.makesaturn = function (radius) {

        radius = typeof radius !== 'undefined' ?  radius : this.saturnRadius;

        var geo = new THREE.SphereGeometry(radius, 32, 32);

        var map = THREE.ImageUtils.loadTexture("img/saturnmap.jpg");
        ...
        var newScale = radius*this.saturnRingScale/this.saturnRadius;

        ring.scale = new THREE.Vector3(newScale,newScale,newScale);
    ...
    this.makeuranus = function (radius) {

        radius = typeof radius !== 'undefined' ?  radius : this.uranusRadius;

        var geo = new THREE.SphereGeometry(radius, 32, 32);

        var map = THREE.ImageUtils.loadTexture("img/uranusmap.jpg");
        ...
        var newScale = radius*this.uranusRingScale/this.uranusRadius;
    ...
    this.makeneptune = function (radius) {

        radius = typeof radius !== 'undefined' ?  radius : this.neptuneRadius;

        var geo = new THREE.SphereGeometry(radius, 32, 32);

        var map = THREE.ImageUtils.loadTexture("img/neptunemap.jpg");
    ...
    this.makeOuter = function (radius) {
        radius = typeof radius !== 'undefined' ?  radius : 4000;

        var geo = new THREE.SphereGeometry(radius, 100, 100);

        var map = THREE.ImageUtils.loadTexture("img/galaxy_starfield.png");
    ...
    this.makeMoon = function (radius) {

        radius = typeof radius !== 'undefined' ?  radius : this.moonRadius;

        var geo = new THREE.SphereGeometry(radius, 10, 10);

        var map = THREE.ImageUtils.loadTexture("img/moonmap.jpg");
    ...
    this.makeSunLight = function () {
        ...
        var textureMau = THREE.ImageUtils.loadTexture("img/mauchoi.png");

        var textureChoi = THREE.ImageUtils.loadTexture("img/choi.png");
    ...
    this.createCoreEarth = function(radius){
        ...
        //phan loi
         ...
         var loiGeo = new THREE.SphereGeometry(0.3*radius, 30, 30, 0, 6.3, 0, Math.PI);

         var core = THREE.ImageUtils.loadTexture("img/dungnham2.png");

         var corespec = THREE.ImageUtils.loadTexture("img/bummap.jpg");
        ...
        var mantitrenTrongGeo = new THREE.SphereGeometry(0.6*radius, 35, 35, 0, 4.3, 0, Math.PI);

        var mantitrenTrongMaterial = new THREE.MeshPhongMaterial({color: 0xdd3300});

        //mantitrenTrongMaterial.side = THREE.DoubleSide;

         var mantitren = THREE.ImageUtils.loadTexture("img/lavatile.jpg");
        ...
        var bitmantitrenTrongGeo = new THREE.RingGeometry(0.3*radius, 0.6*radius, 30, 30);



        // var bitmantitrenTrongGeo = new THREE.CircleGeometry(0.6*radius, 30, 0, Math.PI);
        ...
        var bitmantitrenTrongGeo1 = new THREE.CircleGeometry(0.6*radius, 30, 0, Math.PI);
        ...
        var manti = THREE.ImageUtils.loadTexture("img/dungnham.png");
        ...
        var votrongimg = THREE.ImageUtils.loadTexture("img/dungnham4.png");
        ...
        var texture = THREE.ImageUtils.loadTexture("img/earthpart.png");

        var bumearth = THREE.ImageUtils.loadTexture("img/bumearthpart.png");

        var earthspec = THREE.ImageUtils.loadTexture("img/earthspecpart.png");
